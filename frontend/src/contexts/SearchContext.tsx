...
type SearchContext = {
    ...
    childCount: number;
    hotelId: string;
    saveSearchValues: (destinatin: string, checkIn: Date, checkOut: Date, adultCount: number, childCount: number) => void;
};
...
export const SearchContextProvider = ({ children }: SearchContextProviderProps) => {
    ...
    const saveSearchValues = (
        ...
        sessionStorage.setItem("childChild", childCount.toString());
